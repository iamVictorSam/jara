...
import 'package:jara_freestyle/components/deal_rating.dart';
import 'package:jara_freestyle/components/qualityDropDownButton.dart';
                    ...
                    children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextButton(
                                onPressed: () {},
                                child: (const Text('Contact Members', style: TextStyle(fontSize: 15),)),
                              ),
                            ),
                          ],
                        ),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: const [
                                ...
                                Padding(
                                  padding: EdgeInsets.only(left : 8.0),
                                  child: Text('N5000.00', style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w900),),
                                ),
                                Padding(
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Text('Pay with: '),
                            Image.asset('images/card icon.png',),
